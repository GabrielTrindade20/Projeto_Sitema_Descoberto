...
export function EvaporadorPos({ choices, setChoices, updateObservacao }) {
    ...
    const setValPressPos = (value) => {
        setChoices({ ...choices, valPressPos: value });
    };

    const setRegPressPos = (value) => {
        setChoices({ ...choices, regPressPos: value });
    };
            ...
            <View style={styles.questionContainer}>
                <View style={styles.OptionsBooster}>
                    ...
                    <TextInput
                        ...
                        placeholder=""
                        value={valPressPos}
                        onChangeText={(number) => setValPressPos(number)}
                    />
                </View>
            </View>
            ...
            <View style={styles.questionContainer}>
                <View style={styles.OptionsBooster}>
                    ...
                    <TextInput
                        ...
                        placeholder=""
                        value={regPressPos}
                        onChangeText={(number) => setRegPressPos(number)}
                    />
                </View>
            </View>
        </View>
