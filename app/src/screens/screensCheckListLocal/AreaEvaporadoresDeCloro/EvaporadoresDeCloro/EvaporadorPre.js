...
export function EvaporadorPre({ choices, setChoices, updateObservacao }) {
    ...
    const setValPressPre = (value) => {
        setChoices({ ...choices, valPressPre: value });
    };

    const setRegPressPre = (value) => {
        setChoices({ ...choices, regPressPre: value });
    };
            ...
            <View style={styles.questionContainer}>
                <View style={styles.OptionsBooster}>
                    ...
                    <TextInput
                        ...
                        placeholder=""
                        value={valPressPre}
                        onChangeText={(number) => setValPressPre(number)}
                    />
                </View>
            </View>
            ...
            <View style={styles.questionContainer}>
                <View style={styles.OptionsBooster}>
                    ...
                    <TextInput
                        ...
                        placeholder=""
                        value={regPressPre}
                        onChangeText={(number) => setRegPressPre(number)}
                    />
                </View>
            </View>
        </View>
