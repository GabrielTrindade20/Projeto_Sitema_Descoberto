...
import AreaDioxidoCloro from './AreaDioxidoCloro';


import CustomButton from '../../../components/CustomButton';

export default function AbaDioxidoCloro() {
    ...
    const [areaData, setAreaData] = useState({
        AreaDioxidoCloro: {
            ...
            rotamet: null,
            monometro: null,
            operacaoBooster: null,
            regisEntSaiAcido: null,
            regisProvetaAcido: null,
            regisEntSaiClorito: null,
            regisProvetaClorito: null,
            tempoOperacao: null,
            vazaoEta: null,
            dosagemDioxido: null,
            vazaoDioxido: null,
            geradorDioxido: null,
            leitSensFluxoAcido: null,
            leitSensFluxoClorito: null,
            lavadorGases: null,
            // ... outras opções
        },
    ...
    const [showAreaDioxidoCloro, setShowAreaDioxidoCloro] = useState(true);
    const toggleAreaDioxidoCloro = () => {
        setShowAreaDioxidoCloro(!showAreaDioxidoCloro);
    };
